...
public class AuthService {
    public static void renderLoginPage(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    public static void renderRegisterPage(HttpServletRequest req, HttpServletResponse resp) throws IOException {
